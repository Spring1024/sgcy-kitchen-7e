    ...
    animationDelay: `${index * 60}ms`
      ...
      <div className="p-3">
        ...
        <div className="flex items-center justify-between">
          ...
          {quantity === 0 ? <button onClick={onAdd} className="w-8 h-8 rounded-full bg-[#E85D04] text-white flex items-center justify-center hover:bg-[#E85D04]/90 active:scale-90 transition-all shadow-md shadow-[#E85D04]/20">
              ...
              <button onClick={onAdd} className="w-6 h-6 rounded-full bg-[#E85D04] text-white flex items-center justify-center hover:bg-[#E85D04]/90 active:scale-90 transition-all">
